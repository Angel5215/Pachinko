...
void CFiguras::bandeja(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prisma4(float altura, float largo, float profundidad, GLuint text, GLuint text2, GLuint text3)  //Funcion creacion prisma
{
...
void CFiguras::prismaJerarquico(GLuint text, GLuint text2) {
...
void CFiguras::torus(GLfloat radioM, GLfloat radiom, int meridianos, int paralelos )
{
	...
	GLdouble angulop = 2*3.141592/paralelos;
	GLdouble angulom = 2*3.141592/meridianos;
...
void CFiguras::cono(float altura, float radio, int resolucion, GLuint text)
{
	...
	float angulo=2*3.1415926/resolucion;
...
void CFiguras::boton(float radio, float altura, int resolucion, GLuint text)
{
	...
	float angulo=2*3.141592/resolucion;
...
void CFiguras::canal(float radio, float altura, int resolucion, GLuint text)
{
	...
	float angulo=1*3.1415926/resolucion;
